...
CONTEXT_COVERAGE_MATRIX_OFFENSE_CLEAN = TableSchema(
    table_name="context_coverage_matrix_offense_clean",
    columns=OrderedDict([
        ("season", "int64"),
        ("week", "int64"),
        ("team_code", "string"),
        ...
        ("dropbacks", "int64"),
        ("man_pct", "float64"),
        ("fp_per_db_man", "float64"),
        ("zone_pct", "float64"),
        ("fp_per_db_zone", "float64"),
        ("mof_closed_pct", "float64"),
        ("fp_per_db_mof_closed", "float64"),
        ("mof_open_pct", "float64"),
        ("fp_per_db_mof_open", "float64"),
        ("cover_0_pct", "float64"),
        ("cover_1_pct", "float64"),
        ("cover_2_pct", "float64"),
        ("cover_2_man_pct", "float64"),
        ("cover_3_pct", "float64"),
        ("cover_4_pct", "float64"),
        ("cover_6_pct", "float64"),
    ]),
    ...
    required={"season", "week", "team_code"},
    nullable=set(col for col in [
        "games", "dropbacks", "man_pct", "fp_per_db_man", "zone_pct", "fp_per_db_zone",
        "mof_closed_pct", "fp_per_db_mof_closed", "mof_open_pct", "fp_per_db_mof_open",
        "cover_0_pct", "cover_1_pct", "cover_2_pct", "cover_2_man_pct",
        "cover_3_pct", "cover_4_pct", "cover_6_pct"
    ]),
)

CONTEXT_COVERAGE_MATRIX_DEFENSE_CLEAN = TableSchema(
    table_name="context_coverage_matrix_defense_clean",
    columns=OrderedDict([
        ("season", "int64"),
        ("week", "int64"),
        ("team_code", "string"),
...
ALL_SCHEMAS = {
    ...
    "context_coverage_matrix_offense_clean": CONTEXT_COVERAGE_MATRIX_OFFENSE_CLEAN,
    "context_coverage_matrix_defense_clean": CONTEXT_COVERAGE_MATRIX_DEFENSE_CLEAN,

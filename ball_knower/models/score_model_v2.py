...
def _get_feature_columns(df: pd.DataFrame, exclude_patterns: list[str] = None) -> list[str]:
    ...
    exclude_always = [
        ...
        # Phase 11: Pruned features (importance < 0.005)
        # These features had near-zero or zero importance in feature importance analysis
        "is_late_season",
        "is_early_season",
        "home_def_epa_mean",
        "home_off_epa_mean",
        "home_off_success_mean",
        "home_def_success_mean",
        "short_rest_away",
        "short_rest_home",
        "home_adj_def_epa",
        "home_adj_off_epa",
        "away_early_down_epa_mean",
        "away_third_down_success_mean",
        "away_third_down_epa_mean",
        "away_red_zone_success_mean",
        "away_red_zone_epa_mean",
        "away_explosive_rush_rate",
        "away_explosive_pass_rate",
        "away_rush_epa_mean",
        "away_pass_epa_mean",
        "away_def_success_mean",
        "away_off_success_mean",
        "away_def_epa_mean",
        "away_off_epa_mean",
        "home_early_down_epa_mean",
        "home_third_down_success_mean",
        "home_third_down_epa_mean",
        "home_red_zone_success_mean",
        "home_red_zone_epa_mean",
        "home_explosive_rush_rate",
        "home_explosive_pass_rate",
        "home_rush_epa_mean",
        "home_pass_epa_mean",
        "home_adj_off_success",
        "home_adj_def_success",
        "away_adj_off_epa",
        "away_adj_def_epa",
        "away_adj_off_success",
        "away_adj_def_success",
        "matchup_off_epa_diff",
        "matchup_def_epa_diff",
        "home_off_epa_weighted",
        "matchup_def_consistency_diff",
        "matchup_off_consistency_diff",
        "away_def_success_std",
        "away_off_success_std",
        "away_def_epa_std",
        "away_off_epa_std",
        "home_def_success_std",
        "home_off_success_std",
        "home_def_epa_std",
        "home_off_epa_std",
        "third_down_epa_diff",
        "red_zone_epa_diff",
        ...
        "def_epa_diff",
        "off_epa_diff",
        "matchup_explosive_rush_diff",
        "matchup_explosive_pass_diff",
        "matchup_def_success_diff",
        "matchup_off_success_diff",
        "matchup_adj_off_epa_diff",
        "matchup_net_epa_diff",
        "matchup_def_epa_weighted_diff",
        "matchup_net_epa_weighted_diff",
        "home_players_out",
        "away_players_out",
        "away_skill_out",
        "away_off_success_weighted",
        "away_def_success_weighted",
        "matchup_off_epa_weighted_diff",
        "home_def_epa_weighted",
        "home_off_success_weighted",
        "home_def_success_weighted",
        "away_off_epa_weighted",
        "away_def_epa_weighted",
        "away_win_rate",  # 0.003277 - below threshold
    ]
